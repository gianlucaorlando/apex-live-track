...
const UI_TRANSLATIONS = {
  it: {
    ...
    constructorAvailablePointsTitle: "Punti disponibili",
    constructorAvailablePointsBreakdown: "{races} GP · {sprints} sprint",
    constructorTotalPool: "Totale assegnabile",
    constructorMaxTeam: "Max team",
    constructorPointsOfMax: "{current} su {max}",
    ...
    raceLaps: "{laps} giri",
    lapProgress: "Giri",
    lapProgressValue: "{current}/{total}",
    ...
    viewModeAria: "Tipo di visualizzazione live",
    viewModeLadder: "Distacchi",
    viewModeMap: "Mappa",
    gapLadderTitle: "Distacchi dal leader",
    gapLadderAria: "Corsia dei distacchi con la distanza di ogni pilota dal leader",
    gapLadderHint: "Aggiornamento ~4 s · scala √s",
    gapLadderEmpty: "Distacchi live non ancora disponibili",
    gapLadderRaceOnly:
      "I distacchi sono disponibili durante la gara: per questa sessione usa la Mappa",
    gapLadderLapped: "Doppiati",
    gapLadderLappedShort: "+{laps}G",
  ...
  en: {
    ...
    constructorAvailablePointsTitle: "Available points",
    constructorAvailablePointsBreakdown: "{races} GPs · {sprints} sprints",
    constructorTotalPool: "Total pool",
    constructorMaxTeam: "Max team",
    constructorPointsOfMax: "{current} of {max}",
    ...
    viewModeAria: "Live view type",
    viewModeLadder: "Gaps",
    viewModeMap: "Map",
    gapLadderTitle: "Gaps to the leader",
    gapLadderAria: "Gap lane showing each driver's distance to the leader",
    gapLadderHint: "Updates ~4 s · √s scale",
    gapLadderEmpty: "Live gaps are not available yet",
    gapLadderRaceOnly: "Gaps are available during races: use the Map for this session",
    gapLadderLapped: "Lapped",
    gapLadderLappedShort: "+{laps}L",
  ...
  de: {
    ...
    constructorAvailablePointsTitle: "Verfuegbare Punkte",
    constructorAvailablePointsBreakdown: "{races} GPs · {sprints} Sprints",
    constructorTotalPool: "Gesamtpool",
    constructorMaxTeam: "Max. Team",
    constructorPointsOfMax: "{current} von {max}",
    ...
    viewModeAria: "Live-Ansichtstyp",
    viewModeLadder: "Abstaende",
    viewModeMap: "Karte",
    gapLadderTitle: "Abstaende zum Fuehrenden",
    gapLadderAria: "Abstandsspur mit der Distanz jedes Fahrers zum Fuehrenden",
    gapLadderHint: "Aktualisierung ~4 s · √s-Skala",
    gapLadderEmpty: "Live-Abstaende noch nicht verfuegbar",
    gapLadderRaceOnly:
      "Abstaende gibt es nur im Rennen: fuer diese Session die Karte verwenden",
    gapLadderLapped: "Ueberrundet",
    gapLadderLappedShort: "+{laps}R",
