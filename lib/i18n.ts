...
const UI_TRANSLATIONS = {
  it: {
    ...
    mapsConfigured: "Google Maps se configurato · © OpenStreetMap",
  ...
  en: {
    ...
    mapsConfigured: "Google Maps if configured · © OpenStreetMap",
  ...
  de: {
    ...
    mapsConfigured: "Google Maps falls konfiguriert · © OpenStreetMap",
